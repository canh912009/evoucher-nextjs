            ...
            <div className="ass1-section__item col-lg-6">
                <div className="ass1-section">
                    <div className="ass1-section__head">
                        <a href="single_post.html" className="ass1-section__avatar ass1-avatar"><img src="/images/avatar-02.png" /></a>
                        <div>
                    ...
                    <div className="ass1-section__content">
                        ...
                        <div className="ass1-section__image">
                            <a href="single_post.html"><img src="/images/microphone-1209816_1920.jpg" /></a>
                        </div>
                    </div>
            ...
            <div className="ass1-section__item col-lg-6">
                <div className="ass1-section">
                    ...
                    <div className="ass1-section__content">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et inventore obcaecati eum deserunt ut, aperiam quas! Placeat blanditiis consequatur, deserunt facere iusto amet a ad suscipit laudantium unde quidem perferendis!</p>
                        <div className="ass1-section__image">
                            <a href="single_post.html"><img src="/images/blog-rating.png" /></a>
                        </div>
                    </div>
                    <div className="ass1-section__footer">
                        <a href="#" className="ass1-section__btn-upvote ass1-btn-icon"><i className="icon-Upvote" /></a>
            ...
            <div className="ass1-section__item col-lg-6">
                <div className="ass1-section">
                    ...
                    <div className="ass1-section__content">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et inventore obcaecati eum deserunt ut, aperiam quas! Placeat blanditiis consequatur, deserunt facere iusto amet a ad suscipit laudantium unde quidem perferendis!</p>
                        <div className="ass1-section__image">
                            <a href="single_post.html"><img src="/images/dress_owesom.jpg" /></a>
                        </div>
                    </div>
                    <div className="ass1-section__footer">
                        <a href="#" className="ass1-section__btn-upvote ass1-btn-icon"><i className="icon-Upvote" /></a>
            ...
            <div className="ass1-section__item col-lg-6">
                <div className="ass1-section">
                    ...
                    <div className="ass1-section__content">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et inventore obcaecati eum deserunt ut, aperiam quas! Placeat blanditiis consequatur, deserunt facere iusto amet a ad suscipit laudantium unde quidem perferendis!</p>
                        <div className="ass1-section__image">
                            <a href="single_post.html"><img src="/images/frog-1530803_960_720.jpg" /></a>
                        </div>
                    </div>
                    <div className="ass1-section__footer">
                        <a href="#" className="ass1-section__btn-upvote ass1-btn-icon"><i className="icon-Upvote" /></a>
